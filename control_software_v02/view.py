...
from gui_helper import Scrolling_Canvas,Horizontal_Button_Frame,Page
...
class App(Tk):
    ...
    def __init__(self,*args,**kwargs):
        ...
        self.pages = (Opening,Loading,Home,Recipe_Creator,Settings)
...
#change all to pack instead of grid
class Opening(Frame):
    ...
    def cont(self,controller):
        ...
        controller.frames[Loading].prepare_system(controller)
...
class Loading(Frame):
    ...
    def prepare_system(self,controller):
        ...
        #this requires self as an input so the load function can edit text on this screen
